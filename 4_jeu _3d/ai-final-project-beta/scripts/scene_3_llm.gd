...
var _place_pending: Dictionary = {}   # RigidBody3D -> Vector3
...
func _physics_process(_delta: float) -> void:
	...
	# Placement différé : applique les téléports en attente au tick physique
...
func _try_place(slot_idx: int) -> void:
	...
	bd["node"].freeze = true   # reste kinematic
